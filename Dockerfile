...
COPY ./*.csproj ./
COPY ./ExtejProject.ApplicationCore/*.csproj ./ExtejProject.ApplicationCore/
COPY ./ExtejProject.Infrastructure/*.csproj ./ExtejProject.Infrastructure/
COPY ./ExtejProject.SharedModels/*.csproj ./ExtejProject.SharedModels/
COPY ./ExtejProject.Server/*.csproj ./ExtejProject.Server/

# Repeat this for any other projects

# Restore dependencies for each project
RUN dotnet restore ./ExtejProject.ApplicationCore/ExtejProject.ApplicationCore.csproj
RUN dotnet restore ./ExtejProject.Infrastructure/ExtejProject.Infrastructure.csproj
RUN dotnet restore ./ExtejProject.SharedModels/ExtejProject.SharedModels.csproj
RUN dotnet restore ./ExtejProject.Server/ExtejProject.Server.csproj
# Repeat this for any other projects
...
ENTRYPOINT [ "dotnet", "ExtejProject.Server.dll" ]
